import { Camera, CirclePlay, ExternalLink, Mail, Music2 } from 'lucide-react'
import type { ComponentType } from 'react'
import type { Socials } from '../types'

const icons: Record<string, ComponentType<{ size?: number }>> = { instagram: Camera, tiktok: Music2, youtube: CirclePlay, email: Mail }

export default function SocialLinks({ socials, compact = false }: { socials: Socials; compact?: boolean }) {
  const entries = Object.entries(socials).filter(([, social]) => social.url)
