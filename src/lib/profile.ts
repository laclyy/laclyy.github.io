...
const fallbackProfile: Profile = {
  ...
  contactTitle: 'Need an edit? Open a ticket.', contactText: "Commissions are managed through Lacly's Discord ticket system.", commissionCtaText: 'Open a commission ticket',
}
